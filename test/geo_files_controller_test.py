...
test_validate_geofile_parameters = [
    (
        ...
        'raster',
        None,
        (True, {"Bad Request": "Geofile doesn't exist"})
    ),
    (
        'wrong_name',
        'raster',
        {'name': None, 'geotype': 'raster'},
        (True, {"Bad Request": "Geofile name or type is missing"})
    ),
    (
        'wrong_geotype',
        'raster',
        {'name': 'test_table', 'geotype': None},
        (True, {"Bad Request": "Geofile name or type is missing"})
    ),
    (
        'wrong_geotype',
        'raster',
        {'name': 'test_table', 'geotype': 'polygon'},
        (True, {"Bad Request": "Incorrect type of geometry"})
    ),
    (
        'table_name',
        'polygon',
    ...
    (
        'table_name',
        'raster',
        {'name': 'test_table', 'geotype': 'raster'},
        (False, None)
    )
]
