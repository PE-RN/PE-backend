...
class Group(SQLModel, table = True):
    ...
    created_at:datetime = Field(sa_column=Column(pg.DATE, default=datetime.now))
    updated_at:datetime = Field(sa_column=Column(pg.DATE, default=datetime.now))
    deleted_at:datetime = Field(sa_column=Column(pg.DATE, default=datetime.now))
